...
import {getDevices, toggleActuator, shutdownDevice} from '../../services/apiRequests'
                        ...
                        (
                            <Col xs={24} xl={12} key={device.uuid}>
                                <Card
                                    title={device.name} 
                                    key={device.uuid} 
                                    extra={<Button danger icon={<DeleteOutlined />} size='large' onClick={() => {shutdownDevice(device.uuid, setDevicesList)}}/>}
                                    >
